  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/warm" element={<WarmJobs jsonData={data} apply={handleApplyForJob} />} />
        <Route path="/cold" element={<ColdJobs jsonData={data} apply={handleApplyForJob} />} />
        <Route path="/apply" element={<ApplyPage title={jobDetails[0]} description={jobDetails[1]} />} />
      </Routes>
    </div>
  );
}
