    ...
    return (
        <div className="job_wrapper">
            ...
            <form method="post" onSubmit={handleSubmit} className="apply_form">
                ...
                <label>
                    Tell us about yourself: <input name="myInput" placeholder={"I am..."} />
                </label>
                <button type="reset">Reset Form</button>
                <button type="submit" onClick={clickOnSubmit}>Submit form</button>
                {message && <p className="apply_message">Thanks for your application!</p>}
            </form>
        </div>
    )
}